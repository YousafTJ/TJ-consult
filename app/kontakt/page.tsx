...
import { WaitlistHeroBg } from '@/components/ui/waitlist-hero'
...
export default function KontaktPage() {
  ...
  return (
    <>
      {/* White hero section with spinning tech icon rings */}
      <section className="relative min-h-screen bg-white overflow-hidden flex items-center justify-center py-28">
        {/* Spinning tech icon rings */}
        <WaitlistHeroBg />
        ...
        <div className="relative z-20 w-full max-w-lg mx-auto px-4">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 bg-orange-50 border border-orange-200 text-orange-600 px-4 py-2 rounded-full text-sm font-semibold mb-5">
            ...
            <h1 className="text-4xl lg:text-5xl font-black text-gray-900 mb-3 tracking-tight">
              Lad os{' '}
              <span className="text-orange-500">snakke</span>
            </h1>
            <p className="text-gray-600 text-lg mb-3">
              Fortæl mig om dit projekt — jeg finder den bedste løsning til dig.
            </p>
            <p className="text-sm text-gray-400 italic max-w-sm mx-auto leading-relaxed">
              Jeg integrerer jeres daglige arbejdsprocesser i intelligente systemer —
              så I kan fokusere på det der skaber reel værdi.
            </p>
          </div>

          {/* Uiverse-style form card */}
          <div className="relative">
            ...
            {submitted ? (
              <div className="uv-form-container text-center py-8">
                ...
                <h2 className="text-xl font-bold text-white mb-2">Besked modtaget!</h2>
                <p className="text-gray-400 text-sm mb-6">
                  Tak for din henvendelse. Jeg vender tilbage inden for 24 timer.
                </p>
                <button
                  onClick={() => { setSubmitted(false); setForm({ name: '', email: '', phone: '', subject: '', message: '' }) }}
                  className="text-orange-400 hover:text-orange-300 font-semibold text-sm underline underline-offset-4 transition-colors"
                >
                  Send en ny besked
                </button>
              </div>
              ...
              <div className="uv-form-container">
                <div>
                  <p className="text-white font-bold text-lg mb-0.5">Skriv til mig</p>
                  <p className="text-gray-500 text-xs">Alle felter med * er påkrævede</p>
                </div>
          ...
          {/* Quick contact links */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-5 text-sm text-gray-500">
